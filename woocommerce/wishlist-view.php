	...
	<tr>
		...
		<?php if ( $show_stock_status ) : ?>
			...
			<th class="product-stock-status">
				<span class="nobr">
					<?php echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_stock_heading', __( 'Status', 'yith-woocommerce-wishlist' ), $wishlist ) ); ?>
				</span>
			</th>
		<?php endif; ?>
				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
					...
					<?php if ( $show_price || $show_price_variations ) : ?>
						<td class="product-price">
							<strong><?php do_action( 'yith_wcwl_table_before_product_price', $item, $wishlist ); ?></strong>
					...
					<?php if ( $show_last_column ) : ?>
						<td class="product-add-to-cart" width="250">
							...
							<?php if ( $repeat_remove_button ) : ?>
								<a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove_from_wishlist button" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ) ); ?>"><?php //esc_html_e( 'Remove', 'yith-woocommerce-wishlist' ); ?><i class="las la-trash-alt"></i></a>
							<?php endif; ?>
